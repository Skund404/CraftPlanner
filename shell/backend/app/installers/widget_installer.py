...
through the 'craftplanner rebuild-frontend' CLI command after install.
"""
    ...
    async def install(
        ...
        return InstallResult(
            ...
            message=(
                ...
                "Run 'craftplanner rebuild-frontend' to activate new keyword renderers."
            ),
        )
    ...
    async def uninstall(self, name: str) -> InstallResult:
        ...
        return InstallResult(
            ...
            message=(
                ...
                "Run 'craftplanner rebuild-frontend' to remove its keyword renderers."
            ),
        )
