"""Package manifest model — parses craftplanner-package.json.

Every installable CraftPlanner package declares this manifest at the repo root.
...
class PackageManifest(BaseModel):
    """Parsed craftplanner-package.json at the root of any installable package.
