...
The database lives at ~/.craftplanner/userdb.sqlite (configurable).
"""
...
class UserDB:
    ...
    Usage:
        db = UserDB("~/.craftplanner/userdb.sqlite")
        await db.open()
    ...
    def __init__(self, path: str = "~/.craftplanner/userdb.sqlite", dev_mode: bool = False) -> None:
    ...
    async def run_migrations(self) -> None:
        ...
        for migration_file in migration_files:
            ...
            spec = importlib.util.spec_from_file_location(
                f"craftplanner.migrations.{migration_file.stem}",
                migration_file,
            )
