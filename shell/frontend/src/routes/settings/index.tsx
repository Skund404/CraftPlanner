    ...
    return (
      <div className="rounded border border-success/30 bg-success/5 px-4 py-3 space-y-2">
        <div className="flex items-center gap-2 text-success text-sm font-medium">
          <CheckCircle size={14} />
          Reset complete. CraftPlanner is back with a clean slate.
        </div>
        <button
  ...
  return (
    <div className="p-4 max-w-2xl space-y-4">
      ...
      <div className="pt-4 border-t border-border space-y-3">
        <h2 className="text-xs font-semibold uppercase tracking-widest" style={{ color: 'var(--cp-danger)' }}>Danger Zone</h2>
        <FactoryResetSection />
      </div>
    </div>
  )
