// Package git — this file provides write operations on a CraftPlanner data
...
// commitAuthor is the identity used for all commits made by craftplanner-core.
// In a future auth-aware version this will reflect the authenticated user.
var commitAuthor = &object.Signature{
	Name:  "craftplanner-core",
	Email: "core@craftplanner",
}

// Writer writes manifest files to a CraftPlanner data directory that is managed
